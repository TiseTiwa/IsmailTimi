...
const PROJECTS = [
  {
    ...
    caseStudy: {
      problem:
        "LASU students had no unified digital space — academics, social updates and event announcements were scattered across WhatsApp groups and physical notice boards.",
      solution:
        "Built a full-stack social + academic platform with JWT auth, role-based access (student vs lecturer), real-time feeds, and a course management dashboard — all deployed on Vercel with a MongoDB Atlas backend.",
      result:
        "Launched to a pilot cohort of 200+ students. Lecturers reported a 60% drop in WhatsApp group clutter within two weeks.",
    },
  },
  {
    id: 2,
    ...
    caseStudy: {
      problem:
        "Hospital discharge notes are unstructured text — nurses manually re-read them to flag at-risk patients, a slow and error-prone process.",
      solution:
        "Built a Node.js pipeline that parses discharge text, extracts risk signals, and surfaces a dashboard with alert severity scores per patient.",
      result:
        "Demo praised by two healthcare startup founders at a Lagos tech event for the intuitive risk-scoring UX.",
    },
  },
  {
    id: 3,
  ...
  },
  {
    ...
    caseStudy: {
      problem:
        "Client needed a visual-first online presence to attract bookings — their Instagram page wasn't converting followers to paying clients.",
      solution:
        "Designed and built a cinematic, dark-themed portfolio with a lazy-loaded gallery, booking inquiry form and animated hero reel.",
      result:
        "Client reported 3 new booking inquiries within the first week of launch.",
    },
  },
  {
    id: 6,
    ...
    >
      ...
      <div
        style={{
          ...
          inset: 0,
          background:
            "linear-gradient(105deg,rgba(5,5,5,0.60) 20%,rgba(5,5,5,0.28) 60%,rgba(5,5,5,0.45) 100%)",
        }}
      />
      <div
        style={{
          ...
          inset: 0,
          background:
            "radial-gradient(ellipse at 15% 85%,rgba(255,31,61,0.18) 0%,transparent 58%)",
        }}
      />
      <div
        style={{
        ...
        >
          {SOCIALS.map(({ href, icon: Icon }) => (
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.color = "#ff1f3d";
                e.currentTarget.style.borderColor = "rgba(255,31,61,0.5)";
                e.currentTarget.style.boxShadow =
                  "0 0 16px rgba(255,31,61,0.3)";
              }}
              onMouseLeave={(e) => {
      ...
      <motion.button
        ...
        onMouseEnter={(e) =>
          (e.currentTarget.style.boxShadow = "0 0 22px rgba(255,31,61,0.5)")
        }
        onMouseLeave={(e) => (e.currentTarget.style.boxShadow = "none")}
      >
        {playing ? (
          <FiPause size={14} color="#ff1f3d" />
        ) : (
          <FiPlay size={14} color="#ff1f3d" />
        )}
      </motion.button>
    ...
    <section id="about" className="section">
      ...
      >
        ...
        <div ref={textRef} className="sr sr-left">
          ...
          >
            <div
              style={{
                ...
                overflow: "hidden",
                boxShadow:
                  "0 0 0 6px rgba(255,31,61,0.08), 0 0 36px rgba(255,31,61,0.22)",
              }}
            >
              <img
                src={profile}
          ...
          >
            I'm a Computer Science graduate and full-stack developer who turns
            ideas into production-grade web applications. I've shipped platforms
            used by 200+ students, built client portfolios that generated
            bookings within days, and thrive at the intersection of clean code
          ...
          >
            Currently exploring mobile development to broaden my craft. Open to
            remote roles, freelance projects and long-term collaborations.
          </p>
          ...
          <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
            {SOCIALS.map(({ href, icon: Icon }) => (
              <a
                ...
                onMouseEnter={(e) => {
                  e.currentTarget.style.color = "#ff1f3d";
                  e.currentTarget.style.borderColor = "rgba(255,31,61,0.45)";
                }}
                onMouseLeave={(e) => {
  ...
  const groups = [
    {
      ...
      items: SKILLS.filter((s) =>
        ["HTML", "CSS", "JavaScript", "React", "Tailwind", "Figma"].includes(
          s.label,
        ),
      ),
    },
    {
      label: "Backend",
      items: SKILLS.filter((s) =>
        ["Node.js", "Express", "MongoDB", "Python"].includes(s.label),
      ),
    },
    {
      label: "Tools",
      items: SKILLS.filter((s) =>
        ["Vite", "Vercel", "Postman", "Git"].includes(s.label),
      ),
    },
  ];
    ...
    >
      <div className="section" ref={sectionRef}>
        ...
        {groups.map((group, gi) => (
          <div
            key={group.label}
            style={{ marginBottom: gi < groups.length - 1 ? "2.5rem" : 0 }}
          >
            <p
              style={{
                fontSize: "0.7rem",
            ...
            >
              {group.items.map(
                ({ icon: Icon, label, color, yrs, level }, i) => (
                  <motion.div
                    key={label}
...
function Projects() {
  ...
  const normalised = PROJECTS.map((p) => ({
    ...p,
    catNorm: p.cat.toLowerCase().replace("-", ""),
  }));
  const filtered =
    filter === "all"
      ? normalised
        ...
        {cats.map((c) => (
          <button
            ...
            style={{
              ...
              boxShadow:
                filter === c ? "0 0 18px rgba(255,31,61,0.35)" : "none",
            }}
          >
            {c}
          </button>
...
function ExperienceItem({ e, i, isLast }) {
  ...
  return (
    <div
      ...
      style={{
        position: "relative",
        marginBottom: isLast ? 0 : "clamp(1.5rem,3vw,2.25rem)",
...
function FishermenSVG() {
  return (
    ...
    >
      {/* cliff rock */}
      <path
        d="M20 110 L20 55 Q30 45 50 48 L180 48 L180 110 Z"
        fill="#1a1a1a"
        stroke="rgba(255,255,255,0.05)"
        strokeWidth="0.5"
      />
      <path
        d="M20 55 Q30 45 50 48"
        fill="none"
    ...
    >
      ...
      <motion.div
        ...
        style={{
          ...
          borderRadius: "50%",
          background: "#ff1f3d",
          boxShadow: "0 0 8px rgba(255,31,61,0.6)",
        }}
      />
      ...
      >
        <div>
          ...
          <p style={{ fontSize: "0.65rem", color: "#555", marginTop: 2 }}>
            {testimonial.role}
          </p>
        </div>
        <span
          style={{ color: "#eab308", fontSize: "0.6rem", letterSpacing: 1 }}
        >
...
function Testimonials() {
  ...
  useEffect(() => {
    ...
    animVal(setLineP, 900, 300, () => {
      animVal(setBranch1P, 650, 0, () =>
        setShowCards((s) => [true, s[1], s[2]]),
      );
      animVal(setBranch2P, 550, 140, () =>
        setShowCards((s) => [s[0], true, s[2]]),
      );
      animVal(setBranch3P, 550, 280, () =>
        setShowCards((s) => [s[0], s[1], true]),
      );
    });
  }, [fired, shouldReduce]);
  ...
  return (
    <section
      ...
      style={{
        position: "relative",
        overflow: "hidden",
        padding: "clamp(4rem,8vw,6rem) clamp(1.25rem,6vw,3rem)",
      }}
    >
...
function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!PUBLIC_KEY) {
      console.warn(
        "[EmailJS] VITE_EMAILJS_PUBLIC_KEY is not set. Emails will not be sent.",
      );
      setStatus("error");
  ...
  const contacts = [
    {
      href: "mailto:ismailtisetiwa@gmail.com",
      icon: FiMail,
      label: "Email",
      val: "ismailtisetiwa@gmail.com",
    },
    {
      href: "https://wa.me/2347073558984",
      icon: FaWhatsapp,
      label: "WhatsApp",
      val: "+234 707 355 8984",
    },
    {
      href: "https://linkedin.com/in/ismail-timileyin",
      icon: FaLinkedin,
      label: "LinkedIn",
      val: "ismail-timileyin",
    },
    {
      href: "https://calendly.com/ismailtisetiwa/30min",
      icon: FiCalendar,
      label: "Book a call",
      val: "30-min free consultation",
    },
  ];
    ...
    <section id="contact" className="section">
      ...
      >
        <div ref={leftRef} className="sr sr-left">
          ...
          >
            Open to freelance projects, full-time remote roles and interesting
            collaborations. If you have an idea — let's talk. A free 30-minute
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
          ...
          <div>
            ...
            <p style={{ fontSize: "0.78rem", color: "#444" }}>
              © {new Date().getFullYear()} Ismail Timileyin. Designed & built
        ...
        <div style={{ display: "flex", gap: "0.75rem" }}>
          {SOCIALS.map(({ href, icon: Icon }) => (
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.color = "#ff1f3d";
                e.currentTarget.style.borderColor = "rgba(255,31,61,0.4)";
              }}
              onMouseLeave={(e) => {
